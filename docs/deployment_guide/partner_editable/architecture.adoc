...
//TODO Dave, Do we actually deploy three Availability Zones by default? In the template, the default value for ThirdAZ is none.
...
//TODO Dave, Do we actually deploy three nodes by default? In the template, WSFCNode3 is listed as optional, and the description says, "This template deploys two Windows Server Failover Clustering (WSFC) nodes."
