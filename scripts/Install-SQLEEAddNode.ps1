...
Configuration SQLInstall {
    ...
    Node 'localhost'{
        ...
        SqlSetup 'SQLServerAddNodeToCluster'{
            Action                     = 'AddNode'
            ForceReboot                = $false
            UpdateEnabled              = 'False'
            SourcePath                 = 'C:\SQLInstall\'                    
            InstanceName               = 'SIOSSQLSERVER'
            ...
            FailoverClusterNetworkName = 'siossqlserver'
            FailoverClusterIPAddress   = $SQLServerClusterIP
            FailoverClusterGroupName   = 'SIOSSQLSERVER'
